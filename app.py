...
import tkinter as tk # importar toda la librería
from tkinter import ttk ## solo importa ttk
...
class APP(tk.Tk):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.title("App que mejora la movilidad de personas con discapacidad")
        ...
        contenedor_principal = tk.Frame( self ,bg = "light green")
...
class Frame_1(tk.Frame):
    ...
    def __init__(self, container, controller,*args, **kwargs):
        ...
        L_1 = tk.Label( self, text = "MI PRIMER FRAME CON POO Y TKINTER", font = ("Times New Roman",14,"bold"),bg = "light green",fg = "blue" )
        L_1.grid(row = 0, column = 0, columnspan = 4, sticky = "n")
        L_2 = tk.Label( self, text = "Ingrese Nombre: ", font = ("Times New Roman",12),bg = "light green" )
        ...
        self.L_3 = tk.Label( self, textvariable = "", font = ("Times New Roman",12,"bold"),bg = "light green" )
...
class Frame_2(tk.Frame):
    ...
    def __init__(self, container,controller,*args, **kwargs):
        ...
        L_1 = tk.Label( self, text = "MI FIRST FRAME WITH OOP AND TKINTER", font = ("Times New Roman",14,"bold"),bg = "light green",fg = "blue" )
        L_1.grid(row = 0, column = 0, columnspan = 4, sticky = "n")
        L_2 = tk.Label( self, text = "Entry name: ", font = ("Times New Roman",12),bg = "light green" )
        L_2.grid(row = 1, column = 0, sticky = "w")
